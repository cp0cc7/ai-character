...
const form = useForm<z.infer<typeof formSchema>>({
    ...
    const onSubmit = async (values:z.infer<typeof formSchema>) => {
        try{
        if(initialData){
            //update character fucntionality
            await axios.patch(`/api/character/${initialData.id}`,values);
        } else{
            //create character rucntionality
    ...
    return(
        <div className="h-full p-4 space-y-2 max-w-3xl mx-auto">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="soace-y-8 pb-10">
                ...
                <div className="space-y-2 w-full">
                    <div>
                        <h3 className="calss-lg font-medium mt-8">
                            Configuration
                        </h3>
                        <p className="text-sm text-muted-foreground">
                ...
                <FormField
                    ...
                    render={({field})=>(
                        <FormItem className="col-span-2 md:col-span-1 mt-5">
                            ...
                            <FormDescription>
                            Give a conversation example in how you would like your character to communicate. The more example conversations you give, the more accuracte your character will be.
                            </FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                    ...
                    <div className ="w-full flex justify-items-center">
                        <Button className="mt-4" size="lg" disabled={isLoading}>
